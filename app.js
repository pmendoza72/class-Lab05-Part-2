...
function multiply(x,y) {
  var a = x*y;
  var b = 'The product of ' + x + ' and ' + y + ' is ' + a + '.';
  return [a,b];
}
//
...
function sumAndMultiply(x,y,z) {
  var a = x+y+z;
  var b = x*y*z;
  var c = x + ' and ' + y + ' and ' + z + ' sum to ' + a + '.';
  var d = 'The product of ' + x + ' and ' + y + ' and ' + z + ' is ' + b + '.';
  return [a,b,c,d];
}
...
// for (var i=0; i<sumArray.length; i++ ) {
  ...
  var a = array[0]+array[1]+array[2];
  var b = array[0] + ',' + array[1] + ',' + array[2] + ' was passed in as an array of numbers, and ' + a + ' is their sum.';
  return [a,b];
}
...
function multiplyArray(array) {
  ...
  var a = array[0]*array[1]*array[2];
  var b = 'The numbers ' + array[0] + ',' + array[1] + ',' + array[2] + ' have a product of ' + a + '.';
  return [a,b];
}
